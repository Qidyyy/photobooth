      ...
      <div className="max-w-4xl w-full space-y-12 animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          <button
            ...
            className="group relative flex flex-col items-center justify-center gap-4 md:gap-6 p-4 md:p-8 rounded-xl bg-white border-2 border-stone-200 hover:border-[#745e59] transition-all duration-300 hover:shadow-xl w-full"
          >
            ...
            <div className="text-center space-y-1">
              <p className="text-sm text-stone-500">Classic 4-photo vertical strip</p>
            </div>
          </button>
